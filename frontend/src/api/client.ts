...
export const transactionRoutes = {
  ...
  crossCurrencyReceipt: { label: "Cross Currency Receipt", preview: "/transactions/cross-currency-receipt/preview", post: "/transactions/cross-currency-receipt/post" },
  crossCurrencyPayment: { label: "Cross Currency Payment", preview: "/transactions/cross-currency-payment/preview", post: "/transactions/cross-currency-payment/post" },
